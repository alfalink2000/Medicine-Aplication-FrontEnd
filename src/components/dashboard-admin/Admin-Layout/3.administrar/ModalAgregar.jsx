...
import { InsertVistaPublica } from "../../../../actions/vista_publica";
...
export const ModalRegister = () => {
  ...
  const ConfirmarFormulario = () => {
    if (
      values.img_informacion == null ||
      values.img_1_direccion == null ||
      values.img_2_direccion == null ||
      values.img_3_direccion == null ||
      values.titulo_vista === "" ||
      ...
      dispatch(InsertVistaPublica(formData));

      //A partir de aqui la insercion de Servicios :
